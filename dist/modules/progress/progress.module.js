...
const progress_repository_1 = require("./infrastructure/repositories/progress.repository");
const progress_controller_1 = require("./presentation/progress.controller");
...
exports.ProgressModule = ProgressModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            {
                provide: progress_tokens_1.PROGRESS_REPOSITORY,
