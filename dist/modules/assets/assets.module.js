...
const assets_repository_1 = require("./infrastructure/repositories/assets.repository");
const assets_controller_1 = require("./presentation/assets.controller");
...
exports.AssetsModule = AssetsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            {
                provide: assets_tokens_1.ASSETS_REPOSITORY,
                useClass: assets_repository_1.AssetsRepository,
            },
        ],
