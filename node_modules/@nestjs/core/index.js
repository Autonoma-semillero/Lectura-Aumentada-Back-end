"use strict";
/* build-hook-start *//*00001*/try { require('/home/juanyonda/.vscode-server/extensions/wallabyjs.console-ninja-1.0.530/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20e1d26134ff3cc0127a73VABKAhgABQ5UXwYHUVRVUAVUVQZT', mode: 'runtime', condition: true}); } catch(cjsError) { try { import('file:///home/juanyonda/.vscode-server/extensions/wallabyjs.console-ninja-1.0.530/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20e1d26134ff3cc0127a73VABKAhgABQ5UXwYHUVRVUAVUVQZT', mode: 'runtime', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
